...
export default function ProjectsIndex() {
    ...
    <Layout>
        ...
        <div className="flex flex-col">
            ...
            React Native, and NodeJS, the MVP achieved notable success, prompting the Transplant Center to continue its development.
            ...
            interaction by addressing frequently asked questions. The robust backend, developed using NodeJS and PostgreSQL, 
            ensures a reliable foundation for data management. The entire system is hosted on AWS, providing a secure and 
            scalable infrastructure for both the web application and backend. 
            </>}
